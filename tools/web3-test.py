...
with open('./1.csv', ) as f:
    ...
    for row in lines:
        ...
        url = f"https://api.polygonscan.com/api?module=account&action=tokenbalance&contractaddress=0x2791bca1f2de4661ed88a30c99a7a9449aa84174&address={Address_pm.strip()}&tag=latest&apikey=7JKV"
        # 获取响应数据 res.text
        # print(url)
